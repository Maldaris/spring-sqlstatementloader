package edu.stetson.form; import java.io.IOException; import 
java.util.HashMap; import java.util.Map; import 
org.apache.commons.io.IOUtils; import org.slf4j.Logger; import 
 ...
 */ public class SqlStatementLoader {
	...
	public SqlStatementLoader(ClassLoader contextCL) {
		this.cl = contextCL;
		this.resolver = new 
PathMatchingResourcePatternResolver(this.cl);
...
PathMatchingResourcePatternResolver(this.cl);
	...
	public int loadStatementsByPattern(String path) {
		...
		try {
			...
			if(res.length == 0){
				throw new Exception("No such resources 
matching pattern.");
			}
		} catch (IOException e) {
			if (logger != null)
